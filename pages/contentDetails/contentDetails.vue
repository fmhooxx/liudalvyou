<template>
	...
	<view>
		<!-- 头部照片区域 -->
		<view class="banner">
			<image :src="details.ImageUrl1" mode="scaleToFill"></image>
			<view class="banner-content">
				<view class="banner-title">{{details.ProductName}}</view>
				<view class="banner-price">¥{{details.MinSalePrice}}起/人</view>
			</view>
		</view>
		<!-- 订单相关信息 -->
		...
		<view class="introduce">
			...
			<view class="introduce-content" v-for="(item, index) in tripIntroduce" :key="index">
